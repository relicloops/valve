...
static const vl_verb_t verb_network = {
    ...
    .usage = "demo-separate network --proxy.lane <lane> [--proxy.cpus <n>]",
};
...
static const vl_verb_t verb_page_add = {
    ...
    .usage = "demo-separate page add --name <string> [options]",
};
...
static const vl_verb_t verb_page = {
    ...
    .usage = "demo-separate page <add> [options]",
};
...
int main(int argc, char **argv) {
  const vl_executable_t settings = {
      .program_name = "demo-separate",
      .program_version = "0.1.0",
      .description = "Complete Valve example (separate assign).",
