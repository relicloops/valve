...
[![Version](https://img.shields.io/badge/version-1.1.0--001-lightgrey.svg)](meson.build)
...
`v1.1.0-001` is the current published tag. When upgrading, change `revision` to the latest published Valve version tag.
