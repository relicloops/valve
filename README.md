...
[![Version](https://img.shields.io/badge/version-1.2.0--008-lightgrey.svg)](meson.build)
...
`v1.2.0-008` is the current published tag. When upgrading, change `revision` to the latest published Valve version tag.
