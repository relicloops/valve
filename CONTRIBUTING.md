...
Public docs live at [valve.relicloops.org](https://valve.relicloops.org). The README, `docs/`, and the public headers in this repository remain the source of truth when they disagree with the site.
